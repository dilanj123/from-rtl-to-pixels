...
## D-027 — Architecture A/B controlled comparison

The corrected single-seed comparison measured A at a 35/40 MHz clean/fail frontier and B at 60/65 MHz, with B reducing the primary synchronous path from 25.731 ns to 16.194 ns. B adds one cycle of latency and increases LUT/FF resources while preserving II=1 and pixel equivalence. Decision: RETAIN B as the timing-oriented variant; A remains the compact baseline.
